 export const COUNTRIES = [
  ...
  { value: "BLM", label: "Saint Barth̩lemy" },
...
// for (const country of countriesWithDuplicates) {
...
// // Or, to log only the values that are duplicated:
// const duplicateValues = duplicates.map(country => country.value);
// console.log("Duplicate Values:", duplicateValues);

// // Or, to log the count of each duplicate:
// const duplicateCounts = {};
// countriesWithDuplicates.forEach(country => {
//     duplicateCounts[country.value] = (duplicateCounts[country.value] || 0) + 1;
// });
// const actualDuplicates = Object.fromEntries(Object.entries(duplicateCounts).filter(([, count]) => count > 1));
// console.log("Duplicate counts", actualDuplicates);
